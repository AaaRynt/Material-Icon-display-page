...
export const fileIcons: FileIcons = {
  ...
  icons: parseByPattern([
    ...
    { name: 'just', fileNames: ['justfile', '.justfile'] },
    {
      ...
      fileNames: ['.jscsrc', '.jshintrc', 'composer.lock', '.jsbeautifyrc', '.esformatter', 'cdp.pid', '.whitesource'],
    },
    {
      name: 'hjson',
    ...
    {
      name: 'xml',
      fileExtensions: ['xml', 'plist', 'xsd', 'dtd', 'xsl', 'xslt', 'resx', 'iml', 'xquery', 'tmLanguage', 'manifest', 'project', 'xml.dist', 'xml.dist.sample', 'dmn', 'jrxml', 'xmp'],
      fileNames: ['.htaccess'],
    },
    ...
    {
      name: 'routing',
      fileExtensions: ['routing.ts', 'routing.tsx', 'routing.js', 'routing.jsx', 'route.ts', 'route.tsx', 'route.js', 'route.jsx', 'routes.ts', 'routes.tsx', 'routes.js', 'routes.jsx'],
      fileNames: ['router.js', 'router.jsx', 'router.ts', 'router.tsx', 'route.js', 'route.jsx', 'route.ts', 'route.tsx', 'routes.js', 'routes.jsx', 'routes.ts', 'routes.tsx'],
    ...
    {
      name: 'settings',
      fileExtensions: ['ini', 'dlc', 'config', 'conf', 'properties', 'prop', 'settings', 'option', 'props', 'prefs', 'sln.dotsettings', 'sln.dotsettings.user', 'cfg', 'cnf', 'tool-versions'],
      fileNames: ['.jshintignore', '.buildignore', '.mrconfig', '.yardopts', 'manifest.mf', '.clang-format', '.clang-format-ignore', '.clang-tidy', '.conf', 'compile_flags.txt'],
    },
    {
      name: 'typescript-def',
    ...
    {
      name: 'visualstudio',
      fileExtensions: ['csproj', 'ruleset', 'sln', 'slnf', 'slnx', 'suo', 'vb', 'vbs', 'vcxitems', 'vcxitems.filters', 'vcxproj', 'vcxproj.filters'],
      fileNames: ['.vsconfig'],
    },
    ...
    {
      name: 'console',
      fileExtensions: ['sh', 'ksh', 'csh', 'tcsh', 'zsh', 'bash', 'bat', 'cmd', 'awk', 'fish', 'exp', 'nu', 'xsh'],
    ...
    {
      name: 'key',
      fileExtensions: ['pub', 'key', 'pem', 'asc', 'gpg', 'passwd', 'shasum', 'sha256', 'sha256sum', 'sha256sums', 'secret'],
      fileNames: ['.htpasswd', 'sha256sums', '.secrets'],
    },
    {
      name: 'keystatic',
      fileNames: ['keystatic.config.tsx', 'keystatic.config.ts', 'keystatic.config.jsx', 'keystatic.config.js'],
    },
    {
      name: 'font',
    ...
    {
      name: 'swift',
      fileExtensions: ['swift', 'xcplayground', 'swiftdeps', 'swiftdoc', 'swiftmodule', 'swiftsourceinfo'],
    ...
    {
      name: 'email',
      fileExtensions: ['edb', 'eml', 'emlx', 'ics', 'mbox', 'msg', 'oft', 'olm', 'ost', 'p7s', 'pst', 'rpmsg', 'tnef'],
      fileNames: ['.mailmap'],
    },
    {
      name: 'audio',
    ...
    {
      name: 'payload',
      fileNames: ['payload.config.js', 'payload.config.mjs', 'payload.config.ts', 'payload.config.mts'],
      light: true,
    },
    {
      name: 'next',
    ...
    {
      name: 'remark',
      fileNames: ['.remarkrc', '.remarkrc.cjs', '.remarkrc.js', '.remarkrc.json', '.remarkrc.mjs', '.remarkrc.yaml', '.remarkrc.yml', '.remarkignore'],
    },
    {
      name: 'remix',
    ...
    {
      name: 'gulp',
      fileNames: ['gulpfile.js', 'gulpfile.mjs', 'gulpfile.ts', 'gulpfile.cts', 'gulpfile.mts', 'gulpfile.babel.js', 'gulpfile.cjs'],
    },
    {
      name: 'nodejs',
    ...
    {
      name: 'sonarcloud',
      fileNames: ['sonar-project.properties', '.sonarcloud.properties', 'sonarcloud.yaml', 'SonarQube.Analysis.xml'],
    },
    {
      name: 'protractor',
    ...
    {
      name: 'eslint',
      fileNames: ['.eslintrc-md.js', '.eslintrc-jsdoc.js', '.eslintrc.base.json', '.eslintignore', '.eslintcache', 'eslint-options.js'],
      patterns: {
    ...
    {
      name: 'mocha',
      fileNames: ['mocha.opts', '.mocharc.yml', '.mocharc.yaml', '.mocharc.js', '.mocharc.cjs', '.mocharc.json', '.mocharc.jsonc'],
    },
    {
      name: 'jenkins',
    ...
    {
      name: 'firebase',
      fileNames: ['firebase.config.js', 'firebase.json', '.firebaserc', 'firestore.rules', 'firestore.indexes.json'],
    },
    {
      name: 'figma',
      fileExtensions: ['fig'],
    ...
    {
      name: 'grunt',
      fileNames: ['gruntfile.js', 'gruntfile.ts', 'gruntfile.cjs', 'gruntfile.cts', 'gruntfile.coffee', 'gruntfile.babel.js', 'gruntfile.babel.ts', 'gruntfile.babel.coffee'],
    },
    {
      name: 'jest',
      fileNames: [
    ...
    {
      name: 'istanbul',
      fileNames: ['.nycrc', '.nycrc.json', '.nycrc.yaml', '.nycrc.yml', 'nyc.config.js', 'nyc.config.cjs', '.istanbul.yml'],
    },
    ...
    {
      name: '3d',
      fileExtensions: ['stl', 'stp', 'step', 'obj', 'o', 'ac', 'dxf', 'fbx', 'mesh', 'mqo', 'pmd', 'pmx', 'skp', 'vac', 'vdp', 'vox', 'gltf', 'glb', '3ds', 'dae', 'ply', 'wrl', 'usd', 'usdz'],
    },
    ...
    {
      name: 'commitizen',
      fileNames: ['.czrc', '.cz.json', '.cz.toml', '.cz.yaml', '.cz.yml', 'cz.json', 'cz.toml', 'cz.yaml', 'cz.yml'],
    },
    {
      name: 'commitlint',
    ...
    {
      name: 'quasar',
      fileNames: ['quasar.conf.js', 'quasar.config.js', 'quasar.conf.ts', 'quasar.config.ts', 'quasar.config.cjs'],
    },
    ...
    {
      name: 'textlint',
      fileNames: ['.textlintrc', '.textlintrc.js', '.textlintrc.cjs', '.textlintrc.json', '.textlintrc.yml', '.textlintrc.yaml', '.textlintignore'],
    },
    ...
    {
      name: 'knip',
      fileNames: ['knip.json', 'knip.jsonc', '.knip.json', '.knip.jsonc', 'knip.ts', 'knip.js', 'knip.config.ts', 'knip.config.js'],
    },
    {
      name: 'taskfile',
    ...
    {
      name: 'werf',
      fileNames: ['werf.yaml', 'werf.yml', 'werf-giterminism.yaml', 'werf-giterminism.yml', 'werf-includes.lock', 'werf-includes.yaml', 'werf-includes.yml'],
    },
    ...
    {
      name: 'garden',
      fileNames: ['garden.yml', 'garden.yaml', 'project.garden.yml', 'project.garden.yaml', '.gardenignore'],
    ...
    {
      name: 'kubernetes',
      fileNames: ['k8s.yml', 'k8s.yaml', 'kubernetes.yml', 'kubernetes.yaml', '.k8s.yml', '.k8s.yaml'],
    },
    {
      name: 'phpstan',
    ...
    {
      name: 'oxc',
      fileNames: ['.oxlintrc.json', '.oxlintrc.jsonc', '.oxfmtrc.json', '.oxfmtrc.jsonc'],
    },
    {
    ...
    {
      name: 'cursor',
      fileNames: ['.cursorignore', '.cursorindexingignore', '.cursorrules', '.cursor', '.cursor.json', '.cursorrc'],
      light: true,
    },
    {
      name: 'metro',
